                    ...
                    <div class="row">
                        <div class="col col-sm-12 col-md-3">
                            <div class="nav flex-column nav-pills pb-5" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <a class="nav-link active mt-2" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">@lang("Basic")</a>
                                <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">@lang("Password")</a>
                                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">@lang("Settings")</a>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col col-md-10 col-lg-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-4 col-md-9 col-form-label">@lang("Name")</label>
                                                <div class="col-sm-8 col-md-9 required">
                                                    <input type="text" name="name" class="form-control" id="inputName" aria-describedby="nameHelp"  value="{{$user->name}}" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputEmail" class="col-sm-4 col-md-9 col-form-label">@lang("Email")</label>
                                                <div class="col-sm-8 col-md-9 required">
                                                    <input type="email" name="email" class="form-control" id="inputEmail" aria-describedby="emailHelp" value="{{$user->email}}" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="selectRole" class="col-sm-4 col-md-9 col-form-label">@lang("Role")</label>
                                                <div class="col-sm-8 col-md-9 required select">
                                                    <select class="custom-select" name="role" required>
                                                        <option value="{{$user->roles()->first()->id}}" selected>{{$user->roles()->first()->description}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputEmail" class="col-sm-4 col-md-9 col-form-label">@lang("Status")</label>
                                                <div class="col-sm-8 col-md-9 required">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail" class="col-sm-4 col-md-9 col-form-label">@lang("Profile Photo")</label>
                                ...
                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                    <div class="row">
                                        <div class="col col-md-10 col-lg-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputPassword" class="col-sm-4 col-md-9 col-form-label">@lang("Password")</label>
                                                <div class="col-sm-8 col-md-9 required">
                                                    <input type="password" name="password" class="form-control" id="inputPassword" aria-describedby="passwordHelp" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputConfirmPassword" class="col-sm-4 col-md-9 col-form-label">@lang("Confirm Password")</label>
                                                <div class="col-sm-8 col-md-9 required">
                                ...
                                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                    <div class="row">
                                        <div class="col col-md-10 col-lg-8">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-md-9 col-form-label">@lang("Locale")</label>
                                                <div class="col-sm-8 col-md-9">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-md-9 col-form-label">@lang("Timezone")</label>
                                                <div class="col-sm-8 col-md-9">
