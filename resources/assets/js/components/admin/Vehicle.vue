    ...
    export default {
        ...
        data: function () {
            ...
            return {
                ...
                vehicleDescription:this.pvehicle.description,
        ...
        methods: {
            ...
            updateFromLookup: function (data) {
                ...
                this.vehicle.engineInfo.capacity = reg.EngineCapacity;
                ...
                this.vehicle.specifications.grossWeight =  reg.GrossWeight;
